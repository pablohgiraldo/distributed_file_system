...
class NameNodeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                ...
                response_deserializer=dfs__pb2.RegisterResponse.FromString,
...
def add_NameNodeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=dfs__pb2.RegisterResponse.SerializeToString,
            ),
...
class NameNodeService(object):
    ...
    def Register(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            dfs__pb2.RegisterResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
